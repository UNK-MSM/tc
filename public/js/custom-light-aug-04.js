		...
		--------------------- */
		 if ($('#sticker').length) {
			$("#sticker").sticky({topSpacing:0});
                 ...
                 if ($('#sticker-2').length) {
			$("#sticker-2").sticky({topSpacing:95});
		 }
		/* --------------------------
...
$(window).load(function(){
	...
	$('.image-bg').each(function() {
		...
		if( width === 0 || height === 0 ) {
			$(this).attr('data-background', "img/backgrounds/moving-background.jpg" );
			
			$(this).removeAttr('style');
			$(this).css("background-image", "url(" + "img/backgrounds/moving-background.jpg" + ")");
		}
	});
});
