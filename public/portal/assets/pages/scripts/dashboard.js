    ...
    return {
        ...
        initAmChart1: function () {
            ...
            var chartOtherData = [{
                    ...
                    "reading": 4.12,
                    "bulletClass": "lastBullet",
                    "predictedRisingClosing": 4.12,
                    "predictedStableClosing": 4.12,
                    "predictedFallingClosing": 4.12
                }, {
                    "date": "22/11/2015",
                    "predictedRisingClosing": 4.53,
                    "predictedStableClosing": 4.32,
                    "predictedFallingClosing": 4.92,
                    "risingRate": 2,
                    "stableRate": 6,
                    "fallingRate": 2,
                    "risingPercent": 20,
            ...
            var chartFallingOtherData = [{
                    ...
                    "date": "22/11/2015",
                    "predictedRisingClosing": 3.93,
                    "predictedStableClosing": 3.62,
                    "predictedFallingClosing": 3.42,
                    "risingRate": 2,
                    "stableRate": 6,
                    "fallingRate": 2,
                    "risingPercent": 20,
            ...
            var urgentData = [{
                    ...
                    "date": "21/11/2015",
                    "reading": 4.12,
                    "predictedClosing": 4.12,
                    "predictedFallingClosing": 4.12
                }];

            /*generateChart("dashboard_amchart_1");
            generateChart("dashboard_amchart_1_1");
            generateRiseFallChart("dashboard_amchart_x1", "يرتفع", "ارتفاع", chartOtherData);
            generateRiseFallChart("dashboard_amchart_x2", "ينخفض", "انخفاض", chartFallingOtherData);
            generateDailyChart("dashboard_amchart_x3", pricePredictions);
            var amChart = generateUrgentChart("dashboard_amchart_x4");*/

            function generateUrgentChart(id) {
                return AmCharts.makeChart(id, {
                    ...
                    graphs: [{
                            d: "g3",
                            title: "السعر المتوقع مع السبب الطارئ",
                            classNameField: "bulletClass",
                            valueField: "predictedClosing",
                            "type": "smoothedLine",
                            valueAxis: "a1",
                            bulletSizeField: "risingRate",
                            lineAlpha: 0.8,
                            lineColor: "#1fc305",
                            balloonText: "احتمال [[percent]]% أن [[description]] السهم عند مستوى [[predictedClosing]]",
                            lineThickness: 1,
                            legendValueText: "[[predictedClosing]]",
                            bullet: "circle",
                            ...
                            title: "السعر المتوقع مع السبب الطارئ",
                            classNameField: "bulletClass",
                            valueField: "predictedFallingClosing",
                            "type": "smoothedLine",
                            valueAxis: "a1",
                            bulletSizeField: "risingRate",
                            lineAlpha: 0.8,
                            lineColor: "#ff0000",
                            balloonText: "احتمال [[fallingpercent]]% أن [[description]] السهم عند مستوى [[predictedFallingClosing]]",
                            lineThickness: 1,
                            legendValueText: "[[predictedFallingClosing]]",
                            bullet: "circle",
                            ...
                            lineColor: "#9e9a93",
                            lineThickness: 2,
                            legendValueText: "[[reading]]",
                            descriptionField: "reading",
                            bullet: "circle",
                            bulletSizeField: "reading",
                            ...
                            labelText: "[[reading]]",
                            labelPosition: "right",
                            balloonText: "آخر سعر إغلاق:[[reading]]",
                            showBalloon: true
                        }],
                    chartCursor: {
                        zoomable: true,
            ...
            function generateDailyChart(id, data) {
                return AmCharts.makeChart(id, {
                    type: "serial",
                    theme: "light",
                    fontSize: 12,
                    ...
                    graphs: [{
                            ...
                            labelText: "[[reading]]",
                            labelPosition: "right",
                            balloonText: "السعر المتوقع:[[reading]]",
                            showBalloon: true
                        }],
                    chartCursor: {
                        zoomable: true,
