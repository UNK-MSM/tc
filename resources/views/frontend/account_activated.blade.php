        ...
        <div class="row">
            <div class="col-md-12" data-animation="fadeInRight">
                <div class="section-title text-left" data-animation="fadeInUp">
                    <!-- Title -->
                    <h2 class="title">تم تفعيل حسابك بنجاح!</h2>
                </div>
                <!-- Content -->
                <p style="text-align: justify; font-weight: bold;">لقد تم تفعيل حسابك بنجاح، يمكنك الآن الدخول لحسابك من خلال <a style="color: #ffc400" href="{{asset(
