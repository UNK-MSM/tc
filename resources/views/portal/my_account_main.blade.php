     ...
     <div class="col-md-7">
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption caption-md">
                        ...
                        <span class="caption-subject font-blue-madison bold uppercase">الاشتراكات الفعالة</span>
                    </div>
                </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption caption-md">
                        <i class="icon-bar-chart theme-font hide"></i>
                        <span class="caption-subject font-blue-madison bold uppercase">الاشتراكات المنتهية</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="table-scrollable table-scrollable-borderless">
                        <table class="table table-hover table-light">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $plan->expire_date }} </td>
                                    <td> 
                                        <a onclick="renewPlan({{ $plan->serial_no }});" href="#">تجديد</a>&nbsp;|&nbsp;
                                        <a onclick="showPlanDetails({{ $plan->serial_no }});" href="#">تفاصيل</a>
                                    </td>
                                </tr>
                                @endforeach
        ...
        <div class="col-md-5">
            ...
            <div>
                <div class="portlet light">
                    <div class="portlet-body">
                        <iframe style="width: 100%; height: 267px;" src="{{ isset($videoLink) ? $videoLink : 'https://www.youtube.com/embed/qJOjEb_87jI' }}?rel=0&controls=1&showinfo=0&fs=0" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
